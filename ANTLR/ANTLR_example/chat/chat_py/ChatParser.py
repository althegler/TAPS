...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write(u"\20N\4\2\t\2\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7")
        buf.write(u"\4\b\t\b\4\t\t\t\4\n\t\n\3\2\6\2\26\n\2\r\2\16\2\27\3")
        buf.write(u"\2\3\2\3\3\3\3\3\3\3\3\3\3\3\4\3\4\3\4\3\4\3\4\3\4\6")
        buf.write(u"\4\'\n\4\r\4\16\4(\3\5\3\5\3\5\3\6\3\6\3\6\3\6\3\7\3")
        buf.write(u"\7\5\7\64\n\7\3\7\3\7\3\7\5\79\n\7\3\7\5\7<\n\7\3\b\3")
        buf.write(u"\b\3\b\3\b\3\b\3\b\3\b\3\t\3\t\3\t\3\t\3\t\3\t\3\n\3")
        buf.write(u"\n\3\n\3\n\2\2\13\2\4\6\b\n\f\16\20\22\2\3\3\2\13\f\2")
        buf.write(u"N\2\25\3\2\2\2\4\33\3\2\2\2\6&\3\2\2\2\b*\3\2\2\2\n-")
        buf.write(u"\3\2\2\2\f;\3\2\2\2\16=\3\2\2\2\20D\3\2\2\2\22J\3\2\2")
        buf.write(u"\2\24\26\5\4\3\2\25\24\3\2\2\2\26\27\3\2\2\2\27\25\3")
        buf.write(u"\2\2\2\27\30\3\2\2\2\30\31\3\2\2\2\31\32\7\2\2\3\32\3")
        buf.write(u"\3\2\2\2\33\34\5\b\5\2\34\35\5\n\6\2\35\36\5\6\4\2\36")
        buf.write(u"\37\7\20\2\2\37\5\3\2\2\2 \'\5\f\7\2!\'\5\16\b\2\"\'")
        buf.write(u"\5\20\t\2#\'\5\22\n\2$\'\7\16\2\2%\'\7\17\2\2& \3\2\2")
        buf.write(u"\2&!\3\2\2\2&\"\3\2\2\2&#\3\2\2\2&$\3\2\2\2&%\3\2\2\2")
        buf.write(u"\'(\3\2\2\2(&\3\2\2\2()\3\2\2\2)\7\3\2\2\2*+\7\16\2\2")
        buf.write(u"+,\7\17\2\2,\t\3\2\2\2-.\t\2\2\2./\7\3\2\2/\60\7\17\2")
        buf.write(u"\2\60\13\3\2\2\2\61\63\7\3\2\2\62\64\7\4\2\2\63\62\3")
        buf.write(u"\2\2\2\63\64\3\2\2\2\64\65\3\2\2\2\65<\7\5\2\2\668\7")
        buf.write(u"\3\2\2\679\7\4\2\28\67\3\2\2\289\3\2\2\29:\3\2\2\2:<")
        buf.write(u"\7\6\2\2;\61\3\2\2\2;\66\3\2\2\2<\r\3\2\2\2=>\7\7\2\2")
        buf.write(u">?\7\r\2\2?@\7\b\2\2@A\7\6\2\2AB\7\r\2\2BC\7\5\2\2C\17")
        buf.write(u"\3\2\2\2DE\7\t\2\2EF\7\16\2\2FG\7\t\2\2GH\5\6\4\2HI\7")
        buf.write(u"\t\2\2I\21\3\2\2\2JK\7\n\2\2KL\7\16\2\2L\23\3\2\2\2\b")
        buf.write(u"\27&(\638;")
        return buf.getvalue()
...
class ChatParser ( Parser ):
    ...
    symbolicNames = [ u"<INVALID>", u"<INVALID>", u"<INVALID>", u"<INVALID>", 
                      ...
                      u"<INVALID>", u"SAYS", u"SHOUTS", u"TEXT", u"WORD", 
                      u"WHITESPACE", u"NEWLINE" ]
    ...
    ruleNames =  [ u"chat", u"line", u"message", u"name", u"command", u"emoticon", 
                   u"link", u"color", u"mention" ]
    ...
    def __init__(self, input, output=sys.stdout):
        super(ChatParser, self).__init__(input, output=output)
    ...
    class ChatContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.ChatContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class LineContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.LineContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class MessageContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.MessageContext, self).__init__(parent, invokingState)
            self.parser = parser

        def emoticon(self, i=None):
            if i is None:
    ...
    class NameContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.NameContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class CommandContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.CommandContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class EmoticonContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.EmoticonContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class LinkContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.LinkContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class ColorContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.ColorContext, self).__init__(parent, invokingState)
            self.parser = parser
    ...
    class MentionContext(ParserRuleContext):
        ...
        def __init__(self, parser, parent=None, invokingState=-1):
            super(ChatParser.MentionContext, self).__init__(parent, invokingState)
            self.parser = parser
